      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-[#1a1a1a] rounded-lg border border-white/5 p-6 mb-6">
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#f5f5f5] mb-2">{workout.name}</h2>
              <span className={`inline-block px-3 py-1 rounded-full text-sm font-semibold border ${colorClass}`}>
                {workout.muscleGroup}
              </span>
            </div>
                ...
                >
                  <div className="flex items-start justify-between gap-4 flex-wrap">
                    <div className="flex-1">
                      ...
                      {exercise.notes && (
                        <p className="text-sm text-[#a0a0a0] mt-2">{exercise.notes}</p>
                      )}
                    </div>
                    <div className="text-right">
